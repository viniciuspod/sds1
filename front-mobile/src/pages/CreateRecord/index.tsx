...
const CreateRecord =() =>{
  ...
  const handleChangePlatform = (slectedPlatform: GamePlatform) => {
      setPlatform(slectedPlatform);
      const gamesByPlatform = allGames.filter(
        game => game.platform === slectedPlatform
      )
  ...
  const handleSubmit =() =>{
    ...
    .catch(() => Alert.alert('Erro ao cadastros os dados!!!!!!!'))
  }
